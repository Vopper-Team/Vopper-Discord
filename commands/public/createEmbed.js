	...
	data: new SlashCommandBuilder()
		...
		.addStringOption(option =>
			option.setName('color')
				.setDescription(
					'Elige el color que quieres que tenga el mensaje',
				)
				.addChoices(
					{
						name: 'Default',
		...
		.addStringOption(option =>
			option.setName('título')
				.setDescription('Escribe el texto del mensaje'),
		)
		.addStringOption(option =>
			option.setName('url')
			...
			option.setName('descripción')
				.setDescription('Agrega el texto que quieras que salga en el mensaje')),
	/**
   *
